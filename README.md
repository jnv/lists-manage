...
_See code: [src/commands/add.ts](https://github.com/jnv/lists-manage/blob/v0.3.0/src/commands/add.ts)_
...
_See code: [src/commands/fix.ts](https://github.com/jnv/lists-manage/blob/v0.3.0/src/commands/fix.ts)_
...
_See code: [src/commands/sort.ts](https://github.com/jnv/lists-manage/blob/v0.3.0/src/commands/sort.ts)_
<!-- commandsstop -->
<!-- prettier-ignore-end -->

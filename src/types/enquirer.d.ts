/* eslint-disable */
// Taken from https://github.com/enquirer/enquirer/pull/82
...
> extends NodeJS.EventEmitter {
  ...
  register(
    type: string,
    prompt: EnquirerStatic.TypeUtils.NoParam<typeof EnquirerStatic.Prompt>
  ): this
   ...
   */
  register(obj: {
    [key: string]: EnquirerStatic.TypeUtils.ValueOrFunc<
      undefined,
      typeof EnquirerStatic.Prompt
    >
  }): this
...
declare namespace EnquirerStatic {
  ...
  namespace PromptType {
    ...
    interface BaseOptions<N extends string> {
      ...
      skip?: TypeUtils.ValueOrFunc<
        Answers<N> | string,
        TypeUtils.ValueOrPromise<boolean>
      > // async
      ...
      validate?: TypeUtils.OneParam<
        string,
        TypeUtils.ValueOrPromise<string | boolean>
      > // async
      ...
      onSubmit?: (
        name: N,
        value: N,
        prompt: EnquirerStatic.Prompt<N>
      ) => TypeUtils.ValueOrPromise<boolean>
      onCancel?: (
        name: N,
        value: N,
    ...
    interface AbstactTypeOptions<N extends string>
      extends BaseTypeOptions<N>,
        BaseOptions<N> {}
